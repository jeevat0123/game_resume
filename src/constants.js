...
export const dialogueData = {
  ...
  grass: `This is my grass. I like to play games on it. I also like to play games on my PC. I made a couple of games in JavaScript/TypeScript and you can check them out `
};
